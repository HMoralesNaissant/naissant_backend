...
public class VisitasController {
    ...
    @Autowired
    VisitasService service;

    private final Logger LOG = LoggerFactory.getLogger(VisitasController.class);
    ...
    @PostMapping
    public ResponseEntity agregar(@RequestBody Visitas v) {
        try {
    ...
    @PutMapping(path = {"/{id}"})
    public ResponseEntity editar(@RequestBody Visitas v, @PathVariable("id") int id) {
        try {
            v.setId(id);
