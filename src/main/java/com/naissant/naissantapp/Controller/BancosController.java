...
public class BancosController {
    ...
    private final Logger LOG = LoggerFactory.getLogger(BancosController.class);
    ...
    @PostMapping
    public ResponseEntity agregar(@RequestBody Bancos b) {
        try {
    ...
    @PutMapping(path = {"/{id}"})
    public ResponseEntity editar(@RequestBody Bancos b, @PathVariable("id") int id) {
        try {
            b.setId(id);
