...
public class ModulosController {
    ...
    @Autowired
    ModulosService service;

    private final Logger LOG = LoggerFactory.getLogger(ModulosController.class);
    ...
    @PostMapping
    public ResponseEntity agregar(@RequestBody Modulos m) {
        try {
    ...
    @PutMapping(path = {"/{id}"})
    public ResponseEntity editar(@RequestBody Modulos m, @PathVariable("id") int id) {
        try {
            m.setId(id);
