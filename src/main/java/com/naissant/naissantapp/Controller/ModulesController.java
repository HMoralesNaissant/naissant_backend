...
public class ModulesController {
    ...
    private final Logger LOG = LoggerFactory.getLogger(ModulesController.class);
    ...
    @PostMapping
    public ResponseEntity agregar(@RequestBody Modules m) {
        try {
    ...
    @PutMapping(path = {"/{id}"})
    public ResponseEntity editar(@RequestBody Modules m, @PathVariable("id") int id) {
        try {
            m.setId(id);
